const btnOldImg2 = document.querySelector('.previousImg');
const btnLastImg2 = document.querySelector('.nextImg');
const container2 = document.querySelector('.container');
const currentImage2 = document.querySelector('.current-image');
